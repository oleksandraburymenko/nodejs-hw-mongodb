...
import { requestResetEmailSchema, resetPasswordSchema, userGoogleAuthCodeSchema } from "../validation/auth.js";
import { requestResetEmailController, resetPasswordController, getGoogleOAuthUrlController, authGoogleController } from "../controllers/auth.js";
...
authRouter.post('/confirm-google-auth', validateBody(userGoogleAuthCodeSchema), ctrlWrapper(authGoogleController));
